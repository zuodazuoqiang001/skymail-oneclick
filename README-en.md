...
In step 1 of the wizard, click **Prefill required permissions**, or open:
...
In the wizard, click **or use the official prefilled link**. Empty dropdowns are fine — Continue to summary → Create Token.

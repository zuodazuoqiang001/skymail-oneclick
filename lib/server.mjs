  ...
  const server = http.createServer(async (req, res) => {
    ...
    try {
      ...
      if (req.method === 'GET' && pathname === '/api/health') {
        return send(res, 200, { ok: true, name: 'skymail-oneclick', appVersion: APP_VERSION, version: WIZARD_VERSION, features: ['vendor', 'cleanup', 'mirrors'] }, { 'Content-Type': 'application/json; charset=utf-8' });
      }
